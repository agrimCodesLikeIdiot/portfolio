  ...
  return (
    <div className={styles.container}>
      ...
      <nav className="flex pl-3 pt-3">
        ...
        <div className="lg:absolute lg:left-[50%] lg:translate-x-[-50%] text-gray-400 font-bold">
        ...
        <div
          id="m-menu"
          className="lg:absolute lg:left-[50%] lg:translate-x-[-50%] text-gray-400 font-bold"
        >
